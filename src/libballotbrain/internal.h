 ...
 * calls db_exec or a transaction function, only tdb_socket_* directly, and
...
struct bb_ctx {
  ...
  int db_opts_set; /* 0 -> falls back to tdb_socket_opts_default() */
 ...
 * above describes. */
static inline tdb_socket_opts_t bb_effective_db_opts(struct bb_ctx *ctx) {
