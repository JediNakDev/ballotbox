# BallotBox: Project Meeting 2

## Changes in Requirement

There are no changes to the requirements. Some use cases were rewritten to be more robust, based on comments from the last meeting.
...
| Unit test                                     | Features owner | Not started (planned once each feature stabilises)                     |
| E2e test                                      | Kenji          | Not started (planned after backend integration)                        |
